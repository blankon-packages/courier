...
Summary:          Courier 0.78.0 mail server
Name:             courier
Version:          0.78.0
...
Packager:         %{PACKAGER}
Source:           http://download.sourceforge.net/courier/courier-0.78.0.tar.bz2
...
Summary: Courier 0.78.0 soft links for sendmail
Group: Applications/Mail
%endif

%package ldap
Summary: Courier 0.78.0 LDAP modules and configuration screen
Group: Application/Mail

%package mysql
Summary: Courier 0.78.0 MySQL configuration screen
Group: Application/Mail

%package pgsql
Summary: Courier 0.78.0 PostgreSQL configuration screen
Group: Application/Mail

%package pop3d
Summary: Courier 0.78.0 Integrated POP3 server
Group: Applications/Mail
Requires: courier = 0.78.0 fileutils

%package imapd
Summary: Courier 0.78.0 Integrated IMAP server
Group: Applications/Mail
Requires: courier = 0.78.0 fileutils

%package webmail
Summary: Courier 0.78.0 Integrated HTTP (webmail) server
Group: Applications/Mail
Requires: courier = 0.78.0 %{apache_documentroot} /etc/cron.hourly
%if %with_gpg2
Requires: gnupg2
%define gpg_option --with-gpg2
%else
...
%package webadmin
Summary: Courier 0.78.0 web-based administration tool
Group: Applications/Mail
Requires: courier = 0.78.0 %{apache_documentroot}
%if %is_not_mandrake
Requires: %{apache_cgibindir}
%endif

%package mlm
Summary: Courier 0.78.0 Integrated Mailing List Manager
Group: Applications/Mail
Requires: courier = 0.78.0

%package mlm-web
Summary: Courier 0.78.0 Integrated web-based mailing list interface
Group: Applications/Mail
Requires: courier-mlm = 0.78.0 %{apache_documentroot}
%if %is_not_mandrake
Requires: %{apache_cgibindir}
%endif

%package maildrop
Summary: Courier 0.78.0 Integrated mail filter
Group: Applications/Mail
Requires: courier = 0.78.0

%package fax
Summary: Courier 0.78.0 fax support
Group: Application/Mail
Requires: courier = 0.78.0 groff ghostscript netpbm-progs mgetty-sendfax

%package maildrop-wrapper
Summary: Courier 0.78.0 soft links for maildrop
Group: Applications/Mail
Requires: courier-maildrop = 0.78.0
